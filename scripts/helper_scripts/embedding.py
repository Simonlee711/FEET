...
Additionally, each class now includes functionality to extract embeddings during inference,
...
class ModelBenchmark:
    ...
    def benchmark(self, batch_size=32):
        """
        Performs benchmarking of the model on the dataset and collects embeddings.
...
class ModelFewShotLearner:
    ...
    It also allows extraction of embeddings from the fine-tuned models.
